...
function descriptions() {
    ...
    switch (type) {
        ...
        case 'IVPX-W':
            ...
            textarea2.innerText =
                ...
                "就像是摆放在货架上的夏威夷果，隔着橱窗看着行人，期待着被推门而入的她轻轻拿起……\n" +
                "但你却始终无法踏出最为关键的一步，当幻想的东西真的发生，你却畏畏缩缩，犹豫不前……\n" +
                "不过，如果有一个食者将你逼入绝境，或者她提出了令你无法拒绝的酬劳的话……\n";
            textarea4.innerText =
                "IVPX-W型猎物时刻幻想着自己被吞下的场景与过程，但幻想可以，来真的不行！除非……";
            break;
        case 'IEAN-W':
        ...
        case 'IVPX-U':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "被吞之前的你：“我就算是被捏死，死外边，从这跳下去，也绝不会屈服于你的肚子！”\n" +
                "被吞下去之后的你：“斯哈斯哈！姐姐的体内好棒！”\n" +
                "你绝对是一个复杂的猎物，因为你知道被吞食这件事到底有多么的危险，食者的体内到底有多么恶心。\n" +
                "但如果你真的深陷其中，你就会很快屈服。一旦食者开始吞食你，你就会感到兴奋。\n" +
    ...
    let speciality = {
        ...
        V: {
            ...
            WPREY: "拥有本能特质的自愿型猎物渴望被吞食的理由通常是因为他们能在这个过程中感到愉悦，他们在生理上享受这一经历。<br>",
